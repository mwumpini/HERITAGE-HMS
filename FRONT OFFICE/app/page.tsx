    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        <div className="px-4 py-6 sm:px-0">
          {/* Mamani Hotel Facilities & Services */}
          <Link href="/rooms" className="block mb-8">
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-4">
                  ...
                  <Link href="/events" className="flex items-center hover:bg-gray-50 p-2 rounded-md transition-colors">
            ...
            <Card>
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <Link href="/events/venues/hall1" className="p-4 border rounded-lg hover:shadow-md transition-shadow">
                  ...
                  <Link href="/events/venues/hall2" className="p-4 border rounded-lg hover:shadow-md transition-shadow">
                    <div className="flex items-center justify-between mb-3">
                  ...
                  <Link href="/events/venues/hall3" className="p-4 border rounded-lg hover:shadow-md transition-shadow">
                    <div className="flex items-center justify-between mb-3">
